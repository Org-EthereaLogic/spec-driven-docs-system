...
- **Path:** `***REMOVED***/.nvm/versions/node/v24.9.0/bin/node`
- **Invoked:** `***REMOVED***/.nvm/versions/node/v24.9.0/bin/claude`
...
**File:** `***REMOVED***/Dev/spec-driven-docs-system/.claude/settings.json`
